...
- **Domaine** : `leonheu.fr` (registrar)
- **Hébergement** : auto-hébergement personnel, VM Debian 12, Docker Compose
- **Coût total** : 0 € hors domaine (registrar) (~10 €/an) — pas de SaaS payant
...
- Snapshot auto-hébergement hebdomadaire (rétention 4 semaines)
...
| Environnement | URL | VM auto-hébergée | Branche |
|---|---|---|---|
...
- Snapshot auto-hébergement hebdo testé en restoration

### 9.5 Monitoring V2 (prévu)

- Loki + Grafana auto-hébergés sur le serveur
...
| Image externalisée (MinIO sur le serveur) | 0.5 sprint | P3 |
...
- `installation.md` — Guide dev local + prod auto-hébergement + troubleshooting
